...
export const STATIC_LOCALE_ROUTE_PAIRS = [
  ...
  { en: "/account", fr: "/fr/account", indexable: false },
  { en: "/account/profile", fr: "/fr/account/profile", indexable: false },
  { en: "/account/addresses", fr: "/fr/account/addresses", indexable: false },
  { en: "/account/orders", fr: "/fr/account/orders", indexable: false },
  ...
  { en: "/checkout/payment", fr: "/fr/checkout/payment", indexable: false },
  { en: "/orders/lookup", fr: "/fr/orders/lookup", indexable: false },
